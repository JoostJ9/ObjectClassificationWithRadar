...
def process_radar_file(file_info):
    """Process a single radar data file and generate a torso-removed spectrogram."""
    ...
    try:
        ...
        # --- FIX: ADD THE NORMALIZATION STEP HERE ---
        ...
        plt.title('Torso-Removed Spectrogram (Centered)')
        plt.xlabel('Time [s]')
        ...
        output_filename = os.path.join(output_dir, f'{base_filename}_torso_removed_centered.png')
...
def batch_process_radar_data(datasets_root='datasets', output_root='spectrograms_torso_removed', num_processes=None):
